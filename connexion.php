...
if (!empty($_POST['nom']) and !empty($_POST['mdp'])) { // Contrôle formulare
    ...
    $reponse = $bdd->prepare('SELECT pseudo, mdp, id, statut, nom_image_background FROM utilisateurs WHERE pseudo = :pseudo'); // Selection de l'utilisateur si il a rempli son pseudo et son mot de passe
