...
if($type_commentaire == "commentaire") {
    if (isset($_POST['ajout_commentaire']) and isset($_SESSION['pseudo']) and isset($_POST['id_news']) and isset($_SESSION['token']) and isset($_POST['token'])) { // Traitement ajout commentaire
