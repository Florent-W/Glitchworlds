<button type="button" name="italique" id="italique" style="font-style: italic;" data-toggle="tooltip" data-placement="top" title="Italique" onclick="ajoutClickBBcodeFormulaire('[i]', '[/i]', nom_contenu_avis)">I</button> <!-- Bouton pour ajouter italique -->
<button type="button" name="gras" id="gras" style="font-weight: bold;" data-toggle="tooltip" data-placement="top" title="Gras" onclick="ajoutClickBBcodeFormulaire('[b]', '[/b]', nom_contenu_avis)">G</button>
<button type="button" name="souligne" id="souligne" style="text-decoration: underline;" data-toggle="tooltip" data-placement="top" title="Souligner" onclick="ajoutClickBBcodeFormulaire('[u]', '[/u]', nom_contenu_avis)">U</button>
<button type="button" name="citation" id="citation" data-toggle="tooltip" data-placement="top" title="Citation" onclick="ajoutClickBBcodeFormulaire('[citation]', '[/citation]', nom_contenu_avis)">“</button> <!-- Bouton pour citer -->
<button type="button" name="gauche" id="gauche" value="G" data-toggle="tooltip" data-placement="top" title="Placer à gauche" onclick="ajoutClickBBcodeFormulaire('[gauche]', '[/gauche]', nom_contenu_avis)"><i class="fas fa-align-left"></i></button>
<button type="button" name="centre" id="center" data-toggle="tooltip" data-placement="top" title="Placer au centre" onclick="ajoutClickBBcodeFormulaire('[center]', '[/center]', nom_contenu_avis)"><i class="fas fa-align-center"></i></button>
<button type="button" name="droite" id="droite" value="R" data-toggle="tooltip" data-placement="top" title="Placer à droite" onclick="ajoutClickBBcodeFormulaire('[droite]', '[/droite]', nom_contenu_avis)"><i class="fas fa-align-right"></i></button>
...
<button type="button" name="gallery" id="gallery" value="Gallerie" data-toggle="tooltip" data-placement="top" title="Galerie d'image" onclick="ajoutClickBBcodeFormulaire('[gallery]', '[/gallery]', nom_contenu_avis)"><i class="fas fa-photo-video"></i></button>
<button type="button" name="image" id="image" value="I" data-toggle="tooltip" data-placement="top" title="Image par lien" onclick="ajoutClickBBcodeFormulaire('[image]', '[/image]', nom_contenu_avis)"><i class="far fa-images"></i></button>
...
<button type="button" name="liste" id="liste" value="L" data-toggle="tooltip" data-placement="top" title="Liste" onclick="ajoutClickBBcodeFormulaire('[liste]', '[/liste]', nom_contenu_avis)"><i class="fas fa-list-ul"></i></button>
<button type="button" name="elementliste" id="elementliste" value="EL" data-toggle="tooltip" data-placement="top" title="Element de Liste" onclick="ajoutClickBBcodeFormulaire('[elementliste]', '[/elementliste]', nom_contenu_avis)"><i class="far fa-list-alt"></i></button>
<select class="selecticone fa selectpicker" name="taille" id="taille" data-placement="top" data-live-search="true" data-width="fit" title="Taille" onchange="ajoutClickBBcodeFormulaire('[taille=' + this.value +']', '[/taille]', nom_contenu_avis)">
    <!-- Selection taille -->
...
<select class="selecticone fa selectpicker" name="titreBBCode" id="titreBBCode" data-placement="top" data-live-search="true" data-width="fit" title="Titre" onchange="ajoutClickBBcodeFormulaire('[titre=' + this.value +']', '[/titre]', nom_contenu_avis)">
    <!-- Selection titre -->
...
<select class="selecticone fa selectpicker" name="couleur" id="couleur" data-placement="top" data-live-search="true" data-width="fit" title="Couleur" onchange="ajoutClickBBcodeFormulaire('[couleur=' + this.value +']', '[/couleur]', nom_contenu_avis)">
    <!-- Selection couleur -->
...
<select class="selecticone fa selectpicker" name="couleurfond" id="couleurfond" data-placement="top" data-live-search="true" data-width="fit" title="Couleur de fond" onchange="ajoutClickBBcodeFormulaire('[couleurfond=' + this.value +']', '[/couleurfond]', nom_contenu_avis)">
