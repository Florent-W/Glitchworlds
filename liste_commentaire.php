        ...
        ?>
                     ...
                     <div class="media-body">
                         ...
                         <?php if (isset($_SESSION['pseudo']) && $_SESSION['statut'] == "Administrateur") { // Si le statut de l'utilisateur est administrateur, on lui autorise à modifier un commentaire  
                            ?>
                             <div class="row">
                                 <div class="col">
                                     <p class="list-group-item-text pull-right text-right lead"><button type="button" name="modifier" class="btn btn-primary" id="modifier" data-toggle="tooltip" data-placement="top" title="Modifier" onclick="ajoutModificationCommentaire('contenu<?php echo htmlspecialchars($donnees['id']); ?>', 'modifier_commentaire', 'modifier_commentaire_formulaire', <?php echo htmlspecialchars($donnees['id']); ?>, 'ajout_commentaire_formulaire', 'id_commentaire')">Modifier</button> / <a href="/gerer_commentaire.php?url=<?php echo htmlspecialchars($_GET['url']); ?>&id_news=<?php echo htmlspecialchars($id); ?>&id_commentaire=<?php echo htmlspecialchars($donnees['id']); ?>&type_commentaire=<?php echo htmlspecialchars($type_commentaire); ?>&action=supprimer_commentaire" class="btn btn-warning">Supprimer</a></p><!-- Suppression du commentaire -->
                                     </a>
                                 </div>
                             </div>
                         <?php } ?>
            ...
            $reponse->closeCursor();
             ...
             <?php } else { // Sinon, il y aura un message pour dire de se connecter
                ?>
                 <div class="alert alert-primary" style="margin-top: 9px;">Veuillez vous <a href="/connexion.php">connecter</a> pour écrire un commentaire. </br>
                 Vous pouvez également vous <a href="/inscription.php">inscrire</a>, cela prend 1 minute !</div>
             <?php
                }
                ?>
 </ul>