...
<div class="modal fade" id="modalListeAimeCommentaire" tabindex="-1" role="dialog" aria-labelledby="modalListeAimeCommentaire" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" method="get" action="/gerer_article.php">
